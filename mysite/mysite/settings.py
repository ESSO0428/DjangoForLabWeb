# 注意 使用 appach 跑的 djagno settting 配置會與 runserver 不太相同
# 底下是 appache 的
# 記得要在存檔完執行 : python manage.py collectstatic
...
sys.path.append('/usr/local/apache2/htdocs/mysite/static')
