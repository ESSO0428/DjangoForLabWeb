...
from .models import Degradomeresult
class DegradomeresultAdmin(admin.ModelAdmin):
    list_display = tuple(field.name for field in Degradomeresult._meta.fields[1:])
    # def dataset(self):
    #     return self.dataset
    # dataset.short_description = 'MY_DATE'
admin.site.register(Degradomeresult, DegradomeresultAdmin)
